...
seo:
  description: How to tour the Komodo Islands from Labuan Bajo, including boat options, the 600,000 IDR park fee, the pink beach, dragons and what we would rebook.
---
...
<Figure src="/assets/img/posts/asia/komodosunset.jpg" alt="Multicoloured sunset viewed over the water from the side of a boat" sizes="100vw" caption="Beautiful sunset near Komodo from our tour boat" class="rounded" />
...
<Figure src="/assets/img/posts/asia/komododaniela.jpg" alt="Daniela sitting on a pink sand beach" sizes="100vw" caption="Daniela enjoying the pink sand beach" class="rounded" />
...
<Figure src="/assets/img/posts/asia/komododragon.jpg" alt="Close up of a Komodo Dragon" sizes="100vw" caption="Close up of a Komodo Dragon" class="rounded" />

...
seo:
  title: How to Use the Budget Sheets
  description: How to use our free travel budget spreadsheet to work out what a trip will cost, track spending per person and stay on budget while you travel.
---
...
It might sound difficult, but it is all very easy to understand once it is down in a spreadsheet! Your spreadsheet can be as simple or as complicated as necessary. On our last two trips I made a spreadsheet to outline our expenses - check them out on the [tools page](/en/tools/). They are currently [Microsoft Excel worksheets](https://excel.cloud.microsoft/), but if you prefer Google Drive, just upload them, and they should automatically convert. If you are having any trouble, let us know!
...
<Figure src="/assets/img/tools/budget/person.png" alt="A budget planning spreadsheet open in Google Sheets" sizes="100vw" class="rounded" />
...
<Figure src="/assets/img/tools/budget/initial.png" alt="A budget planning spreadsheet open in Google Sheets" sizes="100vw" class="rounded" />

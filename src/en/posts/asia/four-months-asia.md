...
{% image "/assets/img/posts/asia/IMG_2502.jpeg", "Us on the coast of Cambodia", "100vw", "Relaxing off the coast of Cambodia", "rounded", "lazy", "auto", "async", "", "" %}
...
{% image "/assets/img/posts/asia/IMG_1030.jpg", "View of mountains in Chiang Mai", "100vw", "View from above in Chiang Mai", "rounded", "lazy", "auto", "async", "", "" %}
...
Check out our visa spreadsheet on [Google Sheets](https://docs.google.com/spreadsheets/d/1EFg3FWKgM6gDelzcTER8YiQYraM1VoJIzemeru35eRA/edit?usp=sharing).

<h2 id="vaccines">Vaccines</h2>

{% image "/assets/img/posts/asia/IMG_0687.jpg", "Jungle scene", "100vw", "Vaccines are necessary for places like this", "rounded", "lazy", "auto", "async", "", "" %}
...
- Polio _(booster for Canadians over age 18)_
- Typhoid
- Malaria Pills
- Rabies _(travel clinic suggested, but due to the high cost ($700 CAD) we decided to risk it)_
...
- Vietnam: _we're still traveling here_
- Malaysia: _we're still traveling here_
- Singapore: _we're still traveling here_
- Indonesia: _we're still traveling here_
- Philippines: _we're still traveling here_
- Timor-Leste: _we're still traveling here_
- Brunei: _we're still traveling here_
...
You can see the entire one (with ✨interactive✨ updates) on [Google Sheets](https://docs.google.com/spreadsheets/d/12G97W4vMMMh4kUDjELmHW9V8xrLxGRIfaOTAzfYjB8A/edit?usp=sharing)!

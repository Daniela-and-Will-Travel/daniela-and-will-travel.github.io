...
The world's largest volcanic island, Iceland is a land of fire and ice. With things to do in every corner of this tiny country, a visit to Iceland will not be soon forgotten.
...
> ❕ Tip: the [Reykjavik City Card](affiliatelink) allows you to visit # museums plus free public transit for the duration of the card. We found that 24h was enough to see the museums we were interested in. In the post, starred museums and attractions aren’t included in the card.
...
A trip to Iceland would not be complete without touring the many natural attractions on the Golden Circle Route. You can either take a tour, or drive through the route yourself. Since we were without a car, we embarked on the [GetYourGuide Golden Circle Tour](linktoGetYourGuide) with 4 main stops:
...
Finally, our stay in Iceland would have been lacking if we did not experience at least one geothermal spa. We decided to try Reykjavik’s newest addition, the Sky Lagoon. Crystal clear waters, a warm waterfall, and views of the ocean as far as the eye can see… and did we mention a swim up bar? We went first thing in the morning, and it really lived up to our expectations. There were three different packages available: the Pure Lite, Pure, and Sky. If you have the cash to spend, we recommend the Pure package, however the Pure Lite was sufficient for us. (Add link to page) If the Sky Lagoon wasn’t enough to get a full hot spring experience, make sure to check out the classic Blue Lagoon.

...
It might sound difficult, but it is all very easy to understand once it is down in a spreadsheet! Your spreadsheet can be as simple or as complicated as necessary. On our last two trips I made a spreadsheet to outline our expenses - check them out on the [tools page](https://daniela-and-will-travel.github.io/en/tools). They are currently [Microsoft Excel worksheets](https://excel.cloud.microsoft/), but if you prefer Google Drive, just upload them, and they should automatically convert. If you are having any trouble, let us know!
